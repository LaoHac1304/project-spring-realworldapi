...
public class UserController {
    ...
    @PutMapping("/user")
    public Map<String,UserDTOReponse> updateUser(@RequestBody Map<String,UserDTOUpdate> userUpdateMap) throws CustomBadRequestException{
        return userService.updateUser(userUpdateMap);
    }
}
